...
With this integration, Rezolve's first-party, accurate, and privacy-compliant location data can be connected and utilised across all of the platforms and apps supported by Segment.
...
1\. Decide on the custom data you’ll be passing from the Rezolve (formerly Bluedot) Events to Segment:

a. [Custom Event Metadata](../Custom%20Data.md) (max. 20)  
b. [Custom Zone Data](../Canvas/What%20is%20Zone%20custom%20data.md) (max. 20)

2. Integrate the Rezolve Point SDK within your mobile app:
...
The table below lists events that Rezolve sends to Segment. These events appear as tables in Segment’s warehouse and as regular events in other Segment’s Destinations.
