...
Before proceeding with the integration, ensure that your stores are set up in Canvas. We recommend contacting your Rezolve representative to assist with importing your stores. Alternatively, you can achieve this using our [Config API](../APIs/Config%20API/Overview.md) or by manually creating the stores in [Canvas](../Canvas/Stores/Store%20management.md).
