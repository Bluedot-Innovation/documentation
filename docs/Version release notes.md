...
Version `16.0.2` is the latest for iOS, but for users who haven't migrated to version 16 yet, we’ve also applied these same fixes to version `15.6.12`.
